##1. Write a temperature converter python program, which is menu driven.
...
##Provide an option to view the conversions stored as list of tuples with
##attributes - from unit value , to unit value sorted by the user’s choice
...
def c_to_k(records):
    ...
    details = ('Celsius',temp,'Kelvin',converted)
...
def c_to_f():
    ...
    details = ('Celsius',temp,'Fahrenheit',converted)
    tuple_insert(records,details)      
...
def f_to_c():
    ...
    details = ('Fahrenheit',temp,'Celsius',converted)
    tuple_insert(records,details)
...
def k_to_c():
    ...
    converted = temp - 273.15
    print("Converted value in celsius = ",converted)     
    details = ('Kelvin',temp,'Celsius',converted)
    tuple_insert(records,details)
